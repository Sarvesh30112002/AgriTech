...
export const Profile = (props) => {
    ...
    useEffect(() => {
        ...
        cropService.getWeeklyCrop({username: user.username}).then(res => {
            console.log(res.heights);
            res.heights.forEach(element => {
                points += element.points;
            });
            
            console.log(points);
            setTotalPoints(points);
            setWeeksDone(res.heights.length);
                        ...
                        <div className="surface-card shadow-2 p-3 border-round">
                            <div className="flex justify-content-between mb-3">
                                <div>
                                    ...
                                    <div className="text-900 font-medium text-xl">Corn</div>
                                </div>
                        ...
                        <div className="surface-card shadow-2 p-3 border-round">
                            <div className="flex justify-content-between mb-3">
                                <div>
                                    ...
                                    <div className="text-900 font-medium text-xl">{totalPoints}</div>
                                </div>
                                <div className="flex align-items-center justify-content-center bg-orange-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                                    <i className="pi pi-euro text-orange-500 text-xl"></i>
                                </div>
                            </div>
                            <span className="text-green-500 font-medium">From corn </span>
                            <span className="text-500">({weeksDone} weeks)</span>
                        </div>
                    </div>
                    <div className="col-12 md:col-6 lg:col-4">
                        <div className="surface-card shadow-2 p-3 border-round">
                            <div className="flex justify-content-between mb-3">
                                <div>
                                    ...
                                    <div className="text-900 font-medium text-xl">Corn: {weeksDone} weeks</div>
                                </div>
                                <div className="flex align-items-center justify-content-center bg-cyan-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                                    <i className="pi pi-inbox text-cyan-500 text-xl"></i>
                                </div>
                            </div>
                            <span className="text-green-500 font-medium">{weeksDone} weeks </span>
                            <span className="text-500">crops uploaded</span>
                        </div>
                    </div>
