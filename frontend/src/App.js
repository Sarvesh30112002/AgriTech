            ...
            onButtonState: async function (status) {
                if (status === 'ONLINE') {
                    if (!this.greetingWasSaid) {
                        ...
                        alanBtnInstance.playText("Hello! I'm Agribot. I am your voice assistant.Welcome to AgriTech platform !!");
                        alanBtnInstance.playText("To awake me just press the microphone button in the bottom right corner and bingo !!! I will be able to address you");
